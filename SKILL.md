...
3. 오피넷 4자리 시군구 코드를 법정동 시군구 코드로 해석해야 하면 `pyvworld.VworldClient.search_district(..., category="L2")` 결과의 5자리 `id`를 `pykrtour.AddressRegion`으로 명시 매칭한다. 코드를 산술 변환하지 않는다.
